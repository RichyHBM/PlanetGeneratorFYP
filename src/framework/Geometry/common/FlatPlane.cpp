...
FlatPlane::FlatPlane( const glm::vec3 &center, const glm::vec2 &size, int spacing )
{
...
void FlatPlane::Update()
{
}

void FlatPlane::Draw( const glm::mat4 &MVP, const glm::mat4 &Model )
{
    mShader->Bind();
